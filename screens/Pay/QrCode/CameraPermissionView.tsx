...
export default function CameraPermissionView({ allowAction, notAllowAction }: { allowAction: () => void; notAllowAction: () => void }) {
	return (
		<View className="flex-1 items-center justify-center px-6 py-8">
			...
			<View className="items-center">
				...
				<Text className="mt-6 px-4 text-center leading-6 text-gray-500 text-md">
					To scan QR codes and securely complete payments, PingMe requires access to your device’s camera.
				</Text>
